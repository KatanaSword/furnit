      ...
      <div className="bg-gray-50 flex flex-col font-rubik sm:gap-10 md:gap-10 gap-[100px] items-center justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="h-[535px] md:h-[892px] md:px-5 relative w-full">
          ...
          <div className="absolute flex md:flex-col flex-row md:gap-10 h-full inset-y-[0] items-center justify-between max-w-[1365px] my-auto right-[0] w-full">
            <div className="flex sm:flex-1 flex-col gap-[30px] items-start justify-start w-[525px] sm:w-full sm:px-5">
              <div className="flex flex-col gap-[18px] items-start justify-start w-full pt-[80px]">
                <Text
                ...
                <div className="sm:gap-5 gap-[50px] grid sm:grid-cols-1 grid-cols-2 justify-center min-h-[auto] w-full">
                  <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-3 items-start justify-start w-[276px]">
                      ...
                      >
                        Elevate your space promptly with our swift furniture
                        delivery service, ensuring your pieces arrive in no
                        time.
                      </Text>
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-3 items-start justify-start w-[276px]">
                      ...
                      <Text
                        ...
                        size="txtRubikRegular14"
                      >
                        Trust in our secure delivery methods, ensuring your
                        furniture reaches your home intact and ready to enhance
                        your living space.
                      </Text>
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-3 items-start justify-start w-[276px]">
                      ...
                      <Text
                        ...
                        size="txtRubikRegular14"
                      >
                        Enjoy peace of mind with our extensive return window,
                        giving you ample time to ensure your furniture suits
                        your needs.
                      </Text>
                    </div>
                  </div>
                  <div className="flex flex-1 flex-col gap-10 items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-3 items-start justify-start w-[276px]">
                      ...
                      >
                        ...
                        assist with any inquiries or concerns, ensuring a
